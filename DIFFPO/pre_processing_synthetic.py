...
class DataHandler_DiffPO:
    ...
    def load_data(self) -> dict:
        ...
        if self.config['evaluation']['clustering_type'] != 'None':
            ...
            #stack everything in the right order [treatment, factual_outcomes, counterfactual_outcomes, features]

            self.merged = pd.concat([treatments, outcomes_y0, outcomes_y1, outcomes_y, features], axis=1)
